            ...
            if ([UIPrintInteractionController isPrintingAvailable])
            {
                actionSheet = [[UIActionSheet alloc] initWithTitle:nil
                                            ...
                                            destructiveButtonTitle:nil
                                                 otherButtonTitles:NSLocalizedString(@"Dropbox", nil), NSLocalizedString(@"Send to CWLW", nil), NSLocalizedString(@"AirPrint", nil), nil];
            }
            else
            {
                actionSheet = [[UIActionSheet alloc] initWithTitle:nil
                                                 ...
                                                 cancelButtonTitle:NSLocalizedString(@"Cancel", nil)
                                            destructiveButtonTitle:nil
                                                 otherButtonTitles:NSLocalizedString(@"Dropbox", nil), NSLocalizedString(@"Send to CWLW", nil), nil];
            }
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_LOW, 0), ^{
        ...
        else if(type == kExportTypeEmail)
        {
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [controller setSubject:[NSString stringWithFormat:NSLocalizedString(@"Diabetik CWLW Export - %@", nil), date]];
