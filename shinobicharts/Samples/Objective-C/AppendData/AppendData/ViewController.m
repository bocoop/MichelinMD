...
- (void)viewDidLoad
{
    ...
    self.chart = [[ShinobiChart alloc] initWithFrame:CGRectMake(0, margin, self.view.bounds.size.width, self.view.bounds.size.height - margin)];
...
- (double)sinOfValue:(NSInteger)value  {
